...
const WrestlerForm = ({ wrestler, setWrestlerData, formNumber }) => {
  ...
  return (
    <div className="text-center ">
      <div className="w-full max-w-xl mx-auto my-4 p-4   shadow-2xl rounded-xl  bg-gray-800 md:max-w-xl border border-gray-200 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 ">
